...
public class TileFluxLampRenderer extends TileEntitySpecialRenderer {
	...
	private static final ResourceLocation modelTexture = new ResourceLocation(Reference.MODEL_FLUX_LAMP_TEXTURE);
	...
	public void renderNozzles(TileEntity entity) {
		if(entity.worldObj.getBlockTileEntity(entity.xCoord, entity.yCoord + 1, entity.zCoord) instanceof TileTube) {
			model.renderTop();
		}
