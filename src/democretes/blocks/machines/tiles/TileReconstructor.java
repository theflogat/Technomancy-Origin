	...
	public void updateEntity() {
		if(!worldObj.isRemote) {
			if(this.contents[0] != null) {
				...
				if(pass) {
					if(ThaumcraftApiHelper.getObjectAspects(this.contents[0]) != null) {						
						AspectList al = ThaumcraftApiHelper.getObjectAspects(this.contents[0]);					
						this.aspectDrain = al.getAspects()[list];
						if(this.aspectDrain != null) {
							if(EssentiaHandler.drainEssentia(this, this.aspectDrain, ForgeDirection.UNKNOWN, 6)) {
