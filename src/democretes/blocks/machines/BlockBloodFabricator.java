...
public class BlockBloodFabricator extends BlockBase {
	...
	public BlockBloodFabricator(int id) {
		super(id);
		setUnlocalizedName(Reference.MOD_PREFIX + LibNames.BLOOD_FABRICATOR_NAME);
	}
	...
	public void registerIcons(IconRegister icon) {
		fabricator = icon.registerIcon(Reference.TEXTURE_PREFIX + LibNames.BLOOD_FABRICATOR_NAME);
	}
