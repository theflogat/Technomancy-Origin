...
public class BlockCosmeticPane extends BlockBase {
	...
	public BlockCosmeticPane(int id) {
		super(id);
		this.setUnlocalizedName(Reference.MOD_PREFIX + LibNames.COSMETIC_PANE_NAME);		
	}
    ...
    public final boolean canThisPaneConnectToThisBlockID(int par1)    {
        return Block.opaqueCubeLookup[par1] || par1 == BlockIds.idCOSMETIC_PANE || par1 == BlockIds.idCOSMETIC_OPAQUE;
    }
